...
const useStyles = createStyles((theme, params: { difficultyOffset: number }) => ({
  ...
  indicator: {
    ...
    '@media (min-height: 1440px)': {
      ...
      r: 65,
      strokeDasharray: 2 * 65 * Math.PI,
      strokeDashoffset: (2 * 65 * Math.PI) - 3,
    },
  },
  button: {
    position: 'absolute',
    ...
    top: '50%',
    transform: 'translate(-50%, -50%)',
    background: 'linear-gradient(135deg, rgba(46, 166, 122, 0.9) 0%, rgba(46, 166, 122, 0.7) 100%)',
    border: '2px solid rgba(46, 166, 122, 0.8)',
    boxShadow: '0 4px 15px rgba(46, 166, 122, 0.3), 0 2px 8px rgba(0, 0, 0, 0.2)',
    width: 48,
    height: 48,
    borderRadius: '50%',
    fontSize: 20,
